...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    grass365AuthUserSubject.add(
      Grass365AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Grass365AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Grass365AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Grass365AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    grass365AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
