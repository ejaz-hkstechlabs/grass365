  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final requestsAllRequestsResponse = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final currentStatus = BubbleBEGroup.allRequestsCall
                                .statuses(
                                  requestsAllRequestsResponse.jsonBody,
                                )
                                ?.toList() ??
                            [];
                          ...
                          child: Row(
                            ...
                            children: List.generate(currentStatus.length,
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  _model.status = currentStatusItem.toString();
                                  safeSetState(() {});
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final currentRequest = BubbleBEGroup.allRequestsCall
                                  .requests(
                                    requestsAllRequestsResponse.jsonBody,
                                  )
                                  ?.toList() ??
