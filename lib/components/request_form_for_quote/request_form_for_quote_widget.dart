...
import '/components/add_discount/add_discount_widget.dart';
import '/components/add_line_item/add_line_item_widget.dart';
import '/components/add_tax_rate/add_tax_rate_widget.dart';
import '/components/client_message/client_message_widget.dart';
...
import 'request_form_for_quote_model.dart';
export 'request_form_for_quote_model.dart';

class RequestFormForQuoteWidget extends StatefulWidget {
  const RequestFormForQuoteWidget({
    super.key,
    this.pRequest,
  });
  ...
  @override
  State<RequestFormForQuoteWidget> createState() =>
      _RequestFormForQuoteWidgetState();
}

class _RequestFormForQuoteWidgetState extends State<RequestFormForQuoteWidget>
    with TickerProviderStateMixin {
  late RequestFormForQuoteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestFormForQuoteModel());
