...
class AddNoteWidget extends StatefulWidget {
  const AddNoteWidget({
    super.key,
    required this.linkedObjID,
    this.note,
  });

  final String? linkedObjID;
                    ...
                    children: [
                      ...
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.apiResulthkg =
                                await BubbleBEGroup.noteCall.call(
                              action: 'create',
                              message: _model.noteTextController.text,
                              linkedObjID: widget.linkedObjID,
                              version: kDebugMode ? 'test' : 'live',
                              appToken: currentAuthenticationToken,
                            );

                            if (NoteStruct.maybeFromMap(
                                            (_model.apiResulthkg?.jsonBody ??
                                                ''))
                                        ?.uid !=
                                    null &&
