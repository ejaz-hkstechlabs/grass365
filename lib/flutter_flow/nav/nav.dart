...
class AppStateNotifier extends ChangeNotifier {
  ...
  Grass365AuthUser? initialUser;
  Grass365AuthUser? user;
  ...
  void update(Grass365AuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'settingsOld',
          path: '/settingsOld',
          builder: (context, params) => const SettingsOldWidget(),
        ),
        FFRoute(
          name: 'clients',
          path: '/clients',
          requireAuth: true,
          builder: (context, params) => const ClientsWidget(),
        ),
        FFRoute(
          name: 'client_details',
          path: '/clientDetails',
        ...
        FFRoute(
          name: 'quotes',
          path: '/quotes',
          builder: (context, params) => const QuotesWidget(),
        ),
        FFRoute(
          name: 'test',
          path: '/test',
        ...
        FFRoute(
          ...
          builder: (context, params) => RequestDetailsWidget(
            request: params.getParam(
              ...
              ParamType.DataStruct,
              isList: false,
              structBuilder: RequestStruct.fromSerializableMap,
            ),
          ),
        )
