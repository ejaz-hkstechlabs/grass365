...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF57BA47);
  late Color secondary = const Color(0xFFE68A2E);
  late Color tertiary = const Color(0xFF9DA63A);
  late Color alternate = const Color(0xFFE5EDE7);
  late Color primaryText = const Color(0xFF111827);
  late Color secondaryText = const Color(0xFF6B7280);
  late Color primaryBackground = const Color(0xFFE8F3E9);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4D57BA47);
  late Color accent2 = const Color(0x4CE68A2E);
  late Color accent3 = const Color(0x4C9DA63A);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color warning = const Color(0xFFFFD633);
  late Color error = const Color(0xFFFF5F52);
  late Color info = const Color(0xFFFFFFFF);
}
